module ActiveAdmin
  module Views
    class IndexAsGallery < ActiveAdmin::Component
      ...
      def build_post(post)
        div for: post, class: "mdi-grid" do
      ...
      def build_cover(post)
        return unless @cover
        div class: "grid-cover" do
          src = render_method_on_post_or_call_proc post, @cover
          image_tag src if src.present?
        end
      end
