  ...
  module Views
    module Pages
      class Base < Arbre::HTML::Document
        ...
        def build_page
          within @body do
            div id: "wrapper" do
              ...
              build_page_content
              build_footer
              build_float_ctrl unless skip_float_ctrl?
              build_hidden_content unless skip_hidden_content?
            end
          end
        end
        ...
        # Returns the hidden sections to render for the current action
        ...
        # Returns the float actions to render for the current action
        ...
        def build_float_ctrl
          ...
          div id: "float_actions", class: klass do
            build_float_actions
          end
        end
